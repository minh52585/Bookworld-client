              ...
              >
                ...
                >
                  ...
                  {item.product.discount && (
                    <div className="absolute top-3 right-3 bg-red-500 text-white px-3 py-1 rounded-full font-bold shadow-lg">
                      -{item.product.discount}%
                    </div>
                  )}
        ...
        {favorites.length > 0 && (
          <div className="mt-12 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <i className="fas fa-tag text-purple-600 text-4xl mb-3"></i>
                <h3 className="text-3xl font-bold text-gray-900 mb-1">
                  {favorites
                    .reduce(
                      (total, item) =>
                ...
                <p className="text-gray-600">Tiết kiệm được</p>
              </div>
              <div>
